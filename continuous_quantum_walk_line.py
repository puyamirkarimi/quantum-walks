...
plt.plot(positions, prob, color='royalblue', label='Quantum walk')
plt.plot(positions, probN_classical, linestyle="--", color='tomato', label='Classical walk')
plt.scatter(positions, prob, marker=".", color='royalblue')
plt.scatter(positions, probN_classical, marker=".", color='tomato')
...
# plt.tight_layout()
# plt.show()
plt.savefig('continuous_time_walks.png', dpi=200)
