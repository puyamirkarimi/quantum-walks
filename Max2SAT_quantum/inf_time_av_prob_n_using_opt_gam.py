...
def get_opt_gammas(n):
    return np.loadtxt("new_opt_gammas_"+str(n)+".txt")
...
if __name__ == "__main__":
    ...
    with open("opt_inf_time_probs_n_"+str(n)+".txt", "ab") as f:         # saves runtimes using time.time()
        np.savetxt(f, probs)
