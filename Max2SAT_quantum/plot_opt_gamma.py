...
if __name__ == '__main__':
    ...
    for i, n in enumerate(n_array):
        ...
        plt.vlines(heur_gam, 0, 400, colors='yellow', linestyles='dotted')
        plt.vlines(mean_gam, 0, 400, colors='lime', linestyles='dotted')
        # plt.vlines(median_gam, 0, 400, colors='lime', linestyles='dotted')
