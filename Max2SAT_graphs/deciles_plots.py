...
axs[0, 0].plot(n_array_aqc_reduced, median_success_probabilities_aqc_hardest_fraction, color='blue', linestyle='--')
...
axs[1, 0].plot(n_array_aqc_reduced, median_durations_qw_hardest_fraction, color='blue', linestyle='--')
# axs[1, 0].plot(n_array_aqc_reduced, fit, color='blue')
axs[1, 0].set_yscale('log', base=2)
axs[1, 0].set_ylabel('$T_{0.99}$')
axs[1, 0].set_xlabel('$n$')
