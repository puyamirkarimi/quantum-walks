...
plt.scatter(n_array_qw, np.log2(median_qw_probs_satisfiable), color='mediumorchid', s=m_size)
plt.scatter(n_array_qw, np.log2(median_qw_probs_unsatisfiable), color='green', s=m_size)
plt.plot(n_array_qw, line(n_array_qw, m_satisfiable[0], c_satisfiable[0]), color='mediumorchid')
...
m_unsatisfiable=par[0],np.sqrt(cov[0,0])
c_unsatisfiable=par[1],np.sqrt(cov[1,1])
plt.scatter(np.log10(n_array_qw), np.log2(median_qw_probs_satisfiable), color='mediumorchid', s=m_size)
plt.scatter(np.log10(n_array_qw), np.log2(median_qw_probs_unsatisfiable), color='green', s=m_size)
plt.plot(np.log10(n_array_qw), line(np.log10(n_array_qw), m_satisfiable[0], c_satisfiable[0]), color='mediumorchid')
...
m_unsatisfiable=par[0],np.sqrt(cov[0,0])
c_unsatisfiable=par[1],np.sqrt(cov[1,1])
plt.scatter(n_array_aqc, np.log2(median_aqc_durations_satisfiable), color='mediumorchid', s=m_size)
plt.scatter(n_array_aqc, np.log2(median_aqc_durations_unsatisfiable), color='green', s=m_size)
plt.plot(n_array_aqc, line(n_array_aqc, m_satisfiable[0], c_satisfiable[0]), color='mediumorchid')
...
# frame2.set_ylim([,])
ax2.scatter(n_array_aqc, residuals_satisfiable, color='mediumorchid', marker='+', s=m_size_res)
ax2.scatter(n_array_aqc, residuals_unsatisfiable, color='green', marker='+', s=m_size_res)
ax2.plot(n_array_aqc, residuals_satisfiable, color='mediumorchid', linestyle='--')
...
m_unsatisfiable=par[0],np.sqrt(cov[0,0])
c_unsatisfiable=par[1],np.sqrt(cov[1,1])
plt.scatter(np.log10(n_array_aqc), np.log2(median_aqc_durations_satisfiable), color='mediumorchid', s=m_size)
plt.scatter(np.log10(n_array_aqc), np.log2(median_aqc_durations_unsatisfiable), color='green', s=m_size)
plt.plot(np.log10(n_array_aqc), line(np.log10(n_array_aqc), m_satisfiable[0], c_satisfiable[0]), color='mediumorchid')
...
# frame2.set_ylim([,])
ax2.scatter(np.log10(n_array_aqc), residuals_satisfiable, color='mediumorchid', marker='+', s=m_size_res)
ax2.scatter(np.log10(n_array_aqc), residuals_unsatisfiable, color='green', marker='+', s=m_size_res)
ax2.plot(np.log10(n_array_aqc), residuals_satisfiable, color='mediumorchid', linestyle='--')
