...
plt.scatter(n_array_qw, np.log2(median_qw_probs_satisfiable), marker='^', color=orange, s=m_size)
plt.scatter(n_array_qw, np.log2(median_qw_probs_unsatisfiable), color=blue, s=m_size)
plt.plot(n_array_qw, line(n_array_qw, m_satisfiable[0], c_satisfiable[0]), color=orange)
plt.plot(n_array_qw, line(n_array_qw, m_unsatisfiable[0], c_unsatisfiable[0]), color=blue)
...
m_unsatisfiable=par[0],np.sqrt(cov[0,0])
c_unsatisfiable=par[1],np.sqrt(cov[1,1])
plt.scatter(np.log10(n_array_qw), np.log2(median_qw_probs_satisfiable), marker='^', color=orange, s=m_size)
plt.scatter(np.log10(n_array_qw), np.log2(median_qw_probs_unsatisfiable), color=blue, s=m_size)
plt.plot(np.log10(n_array_qw), line(np.log10(n_array_qw), m_satisfiable[0], c_satisfiable[0]), color=orange)
plt.plot(np.log10(n_array_qw), line(np.log10(n_array_qw), m_unsatisfiable[0], c_unsatisfiable[0]), color=blue)
x_tick_labels = ['${}$'.format(x) for x in x_ticks]
...
m_unsatisfiable=par[0],np.sqrt(cov[0,0])
c_unsatisfiable=par[1],np.sqrt(cov[1,1])
plt.scatter(n_array_aqc, np.log2(median_aqc_durations_satisfiable), marker='^', color=orange, s=m_size)
plt.scatter(n_array_aqc, np.log2(median_aqc_durations_unsatisfiable), color=blue, s=m_size)
plt.plot(n_array_aqc, line(n_array_aqc, m_satisfiable[0], c_satisfiable[0]), color=orange)
plt.plot(n_array_aqc, line(n_array_aqc, m_unsatisfiable[0], c_unsatisfiable[0]), color=blue)
...
# frame2.set_ylim([,])
ax2.scatter(n_array_aqc, residuals_satisfiable, color=orange, marker='x', s=m_size_res*0.7)
ax2.scatter(n_array_aqc, residuals_unsatisfiable, color=blue, marker='+', s=m_size_res)
ax2.plot(n_array_aqc, residuals_satisfiable, color=orange, linestyle='--')
ax2.plot(n_array_aqc, residuals_unsatisfiable, color=blue, linestyle='--')
...
m_unsatisfiable=par[0],np.sqrt(cov[0,0])
c_unsatisfiable=par[1],np.sqrt(cov[1,1])
plt.scatter(np.log10(n_array_aqc), np.log2(median_aqc_durations_satisfiable), marker='^', color=orange, s=m_size)
plt.scatter(np.log10(n_array_aqc), np.log2(median_aqc_durations_unsatisfiable), color=blue, s=m_size)
plt.plot(np.log10(n_array_aqc), line(np.log10(n_array_aqc), m_satisfiable[0], c_satisfiable[0]), color=orange)
plt.plot(np.log10(n_array_aqc), line(np.log10(n_array_aqc), m_unsatisfiable[0], c_unsatisfiable[0]), color=blue)
...
# frame2.set_ylim([,])
ax2.scatter(np.log10(n_array_aqc), residuals_satisfiable, color=orange, marker='x', s=m_size_res*0.7)
ax2.scatter(np.log10(n_array_aqc), residuals_unsatisfiable, color=blue, marker='+', s=m_size_res)
ax2.plot(np.log10(n_array_aqc), residuals_satisfiable, color=orange, linestyle='--')
ax2.plot(np.log10(n_array_aqc), residuals_unsatisfiable, color=blue, linestyle='--')
ax2.set_xlabel(r'$n$', fontsize=15)
