...
if __name__ == '__main__':
    ...
    for n in range(1, 17):
        ...
        for i in range((n-1)*10000, n*10000):                               # 10000 instances per value of n
            ...
            result = subprocess.run(['./../../mixsat/complete', './../../instances_dimacs_noGT_nondg/'+instance_name+'.txt'], stdout=subprocess.PIPE)
    ...
    with open("mixsat_runtimes_averaged_noGT_nondg.txt", "ab") as f:
        f.write(b"\n")
